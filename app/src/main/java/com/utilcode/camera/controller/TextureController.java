package com.utilcode.camera.controller;
...
import com.utilcode.camera.filter.GroupFilter;
import com.utilcode.camera.filter.NoFilter;
import com.utilcode.camera.filter.TextureFilter;
import com.utilcode.camera.ifs.FrameCallback;
import com.utilcode.camera.ifs.Renderer;
import com.utilcode.camera.util.EasyGlUtils;
import com.utilcode.camera.util.MatrixUtils;
...
public class TextureController implements GLSurfaceView.Renderer {
    ...
    public void setFrameCallback(int width, int height, Context frameCallback){
        ...
        if (frameCallbackWidth > 0 && frameCallbackHeight > 0) {
            ...
            calculateCallbackOM();
            this.mFrameCallback = (FrameCallback) frameCallback;
        } else {
